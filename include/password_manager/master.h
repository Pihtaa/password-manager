...
{
public:
    virtual bool initialize_password_with_approvement(const std::string& password) = 0;
    virtual void hash_and_save_password(const std::string& password) = 0;
    virtual bool verify_password(const std::string& password) const = 0;
    virtual bool data_exists() const = 0;
    virtual bool change_security_level(const std::string& password, SecurityLevel sec_level) = 0;
...
public:
    ...
    bool initialize_password_with_approvement(const std::string& password) override;
    void hash_and_save_password(const std::string& password) override;
    bool verify_password(const std::string& password) const override;
    bool data_exists() const override; 
    bool change_security_level(const std::string& password, SecurityLevel sec_level) override;
